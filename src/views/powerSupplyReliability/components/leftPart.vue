<template>
  <div class="leftPart_powerSupplyReliability">
    <div class="resources">
      <div class="boxTitle">
...
export default {
  ...
  watch:{
    initData(val){
      ...
      val.screenTargetPart01Data.forEach(item=>{
        item.targetContent.forEach(item2=>{
          item2.name = item2.indicatorName.split('/')[1]
          item2.value = item2.indicatorValue.split('/')[1]
          item2.unit = item2.unit.split('/')[1]
        })
      })
      this.allArr = val.screenTargetPart01Data
    ...
    initData2(val){
      this.tabTitle2 = val.screenTargetPart01Data[0].targetTabTitle
      this.tabTitle1 = val.screenTargetPart01Data[1].targetTabTitle
      this.title2 = val.screenTargetPart01Data[0].targetTitle
      this.xaxis = val.screenTargetPart01Data[0].targetContent.xaxis
      this.yyaxis = val.screenTargetPart01Data[0].targetContent.yaxis.map(Number)
      this.gyxis = val.screenTargetPart01Data[1].targetContent.yaxis.map(Number)
      this.leftBottompBar();
    }
  },
  data() {
  ...
  methods: {
    change(e){
      // console.log(this.allArr[e-1]);
      this.leftArr = this.allArr[e-1].targetContent
      this.activeIndex = e
    },
    leftBottompBar() {
      ...
      let arr1 = this.yyaxis,
        arr2 = this.gyxis,
        xAxisArr = this.xaxis;
      let arrPlus = [];
      for (let i = 0; i < arr1.length; i++) {
        let element = arr1[i] + arr2[i];
        arrPlus.push(element);
      }
      // console.log(arr1,arr2,xAxisArr)
      myChart.setOption({
        grid: {
          top: "20%",
          left: "8%",
...
.leftPart_powerSupplyReliability {
  position: absolute;
  top: 88px;
  left: 48px;
  width: 1458px;
  ...
  .resources {
    .content {
      ...
      section {
        ...
        // background: url("/image/powerSupplyReliability/dyhgl.png") no-repeat;
        &:nth-of-type(1) {
          background: url("/image/powerSupplyReliability/left_icon1.png")
            no-repeat;
          background-position: 50% 0%;
          background-size: 86%;
        }
        &:nth-of-type(2) {
          background: url("/image/powerSupplyReliability/left_icon2.png")
            no-repeat;
          background-position: 50% 0%;
          background-size: 86%;
        }
        &:nth-of-type(3) {
          background: url("/image/powerSupplyReliability/left_icon3.png")
            no-repeat;
          background-position: 50% 0%;
          background-size: 86%;
        }
        &:nth-of-type(4) {
          background: url("/image/powerSupplyReliability/left_icon4.png")
            no-repeat;
          background-position: 50% 0%;
          background-size: 86%;
        }
        &:nth-of-type(5) {
          background: url("/image/powerSupplyReliability/left_icon5.png")
            no-repeat;
          background-position: 50% 0%;
          background-size: 86%;
        }
