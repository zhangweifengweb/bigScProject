...
export default {
  ...
  mounted() {
    ...
    // console.log("knaknakguding", this.option);
    this.drawPie(this.id);
  },
  methods: {
    drawPie(id) {
        ...
        plotOptions: {
          pie: {
            ...
            dataLabels: {
              ...
              // useHTML: true,
              formatter: function () {
                return `<div class="pieLabel"><p class="pie_title">${this.point.name}</p><br><p style='font-size:30px' class="num pie_num">${this.point.y}%</p></div>`;
